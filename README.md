...
[![npm package](https://img.shields.io/npm/v/@lcsixp/pickers.svg)](https://www.npmjs.org/package/@lcsixp/pickers)
[![npm download](https://img.shields.io/npm/dm/@lcsixp/pickers.svg)](https://www.npmjs.org/package/@lcsixp/pickers)
...
[![Bundle Size](https://badgen.net/bundlephobia/minzip/@lcsixp/pickers)](https://bundlephobia.com/result?p=@lcsixp/pickers@latest)
...
```sh
// via npm
npm i @lcsixp/pickers

// via yarn
yarn add @lcsixp/pickers
```
...
import { MuiPickersUtilsProvider } from '@lcsixp/pickers';
