...
<PageMeta
  title="Installation"
  description="Step-by-step guide how to install @lcsixp/pickers"
/>

## Installation

Available as an [npm package](https://www.npmjs.com/package/@lcsixp/pickers)
...
@lcsixp/pickers was designed to use the date management library of your choice.
