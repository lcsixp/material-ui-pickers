...
import { MuiPickersContext } from '@lcsixp/pickers';
import { DatePicker, KeyboardDatePicker } from '@lcsixp/pickers';
  ...
  return (
    <div style={{ marginTop: 30 }}>
      <Typography align="center" variant="h5" gutterBottom>
        This page is using for the automate regression of @lcsixp/pickers.
      </Typography>
