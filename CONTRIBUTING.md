...
The following is a set of guidelines for contributing to @lcsixp/pickers. The purpose of these
...
1. Fork the @lcsixp/pickers repository on Github
2. Clone your fork to your local machine `git clone git@github.com:<yourname>/@lcsixp/pickers.git`
...
```sh
git remote add upstream git@github.com:mui-org/@lcsixp/pickers.git
git checkout next
